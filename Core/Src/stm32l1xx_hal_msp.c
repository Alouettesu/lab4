  ...
  /* USER CODE END LCD_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = SEG14_Pin|SEG15_Pin|SEG16_Pin|SEG17_Pin
                          |GPIO_PIN_4|GPIO_PIN_5|SEG18_Pin|SEG19_Pin
                          |SEG20_Pin|SEG21_Pin|SEG22_Pin|SEG23_Pin;
    ...
    GPIO_InitStruct.Pin = SEG0_Pin|SEG1_Pin|SEG2_Pin|GPIO_PIN_6
                          |GPIO_PIN_7|COM0_Pin|COM1_Pin|COM2_Pin
                          |SEG12_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|SEG6_Pin|SEG7_Pin
...
void HAL_LCD_MspDeInit(LCD_HandleTypeDef* hlcd)
{
  ...
  /* USER CODE END LCD_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, SEG0_Pin|SEG1_Pin|SEG2_Pin|GPIO_PIN_6
                          |GPIO_PIN_7|COM0_Pin|COM1_Pin|COM2_Pin
                          |SEG12_Pin);

    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|GPIO_PIN_1|SEG6_Pin|SEG7_Pin
                          |SEG8_Pin|SEG9_Pin|SEG10_Pin|SEG11_Pin
                          |SEG3_Pin|SEG4_Pin|SEG5_Pin|SEG13_Pin
                          |COM3_Pin);
